 ...
 * @author quang
 */
public class DangNhapNhomTruong extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DangNhapNhomTruong.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
